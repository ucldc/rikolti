...
class TindRecord(Record):
    ...
    def UCLDC_map(self):
        ...
        return {
            ...
            "creator": self.get_marc_data_fields(["700", "710"], ["a", "e"]),
        ...
        self.add_validatable_fields([
            {
                "field": "is_shown_by",
                "validations": [
                    TindValidator.str_match_ignore_url_protocol,
...
class TindVernacular(Vernacular):
    record_cls = TindRecord
